...
- **Pipeline**: Whisper transcription → OpenAI cue translation → ffmpeg burn → realtime gallery
- **Free-tier watermark**, per-plan quota (seconds of render/month)

## Stack

Next.js 16.2 (App Router) · React 19 · TypeScript strict · Tailwind v4 · shadcn/ui v4 · Supabase (eu-west) · Vercel · Sentry · next-intl (en/fr) · ffmpeg · Whisper · OpenAI
